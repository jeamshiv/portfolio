  ...
  render() {
    return (
      <>
        <div className="mt-lg-5" style={{ position: 'relative' }}>
          <svg xmlns="http://www.w3.org/2000/svg" style={{ marginBottom: '-20px' }} viewBox="0 0 1440 260">
            <path
              fill="#5f19dd"
              fillOpacity="1"
              d="M0,128L80,149.3C160,171,320,213,480,208C640,203,800,149,960,128C1120,107,1280,117,1360,122.7L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
          </svg>
        ...
        <div className="container-fluid gradientBackgroundPrimary py-1"></div>
      </>
    );
  }
}
