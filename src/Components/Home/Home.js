        ...
        return (
            ...
            <section className="container-fluid" id="head">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-6 col-md-6 text-center align-self-center order-sm-2 wow bounceInDown" data-wow-delay="0.6s">
                        <img src="../assets/boywithcomputerpink.png"  className="img-fluid banner-image mt-5 mt-sm-0" alt="jeamshiv portfolio header" />
                    </div>
                    ...
                    <div className="col-lg-6 col-md-6 align-self-center order-sm-1 wow fadeInLeft" data-wow-delay="1s">
                        <div className="pb-5 pl-2 pl-lg-5 pt-lg-5 mt-sm-5">
                            <h5 className="pb-0">HELLO, IM JEAMSHIV <span className="wave"><img src="../assets/hand.png" width="40px" alt=""/></span></h5>
                            <h1>Web Developer</h1>
                            <p>I am React Developer and React Native App Developer.</p>
                            <button className="primary-button">Hire Me!</button> &nbsp; 
                            <a href="/assets/resume.pdf" download="Shivam Resume" className="alternative-button" >Get CV</a>
                        </div>
                    </div>
                ...
                <div className="row">
                    <div className="col-md-6 pr-lg-5 pr-md-5 pt-4">
                        ...
                        <div className="row my-4 experience_card">
                            ...
                            {this.renderExperience('Cyberflow', 'Web Developer | May 2021 - Present', 'Working with lastest technologies, UI, React, and React Native app development.', '0.6s')}
                            ...
                            <div className="card-body pt-4">
                                ...
                                <div id="content">
                                    <ul className="timeline">
                                        {this.renderTimeline('2018-2021', 'BA Graduation', 'I have recently completed by Graduation from IGNOU')}
                                        {this.renderTimeline('2018-2020', 'It-Expert | Diploma in IT', 'I Joined Arth Institute to get the fundamental knowledge of Web development.')}
                                        {this.renderTimeline('2018', '12th Passed | CBSE Board', 'I have completed by 12th from Government School')}
                                        {this.renderTimeline('2016', '10th Passed | CBSE Board', 'I have completed by 10th from same Government School')}
                                    </ul>
                                </div>
            ...
            <section className="container services">
                ...
                <div className="row text-center">
                    {this.renderServicesCard('service1 p-5 m-4', 'assets/logo-branding.png', 'UI/UX Design','Design is an important aspect in todays digital era and the design of your website or app can help your brand or businesss. We help our clients with UI and UX Design Growth Marketing Mobile & Web Apps.', '0.6s')}
                    {this.renderServicesCard('service2 p-5 m-4', 'assets/web-develpment.png', 'Web Development','Our custom web development services include both front-end and back-end development. Whether it is enhancing an existing application or new one, my developers team are available.', '0.7s')}
                    {this.renderServicesCard('service3 p-5 m-4', 'assets/app-develpment.png', 'App Development','We develop mobile apps. My spelialised team of android app development team will come up with the product that user will love to use. We create mobile apps using React Native.', '0.8s')}
                </div>
            </section>
            ...
            <section className="px-3 pt-5">
                ...
                <div className="row">
                    ...
                    <div key={key} className="col-lg-4 col-md-6 portfolioInfoCardWrapper mt-3 wow fadeInUp" data-wow-delay={key/2+0.2+'s'}>
